...
p=B/'app/src/main/java/com/localqbank/library/SettingsScreen.kt';s=p.read_text()
s=s.replace('Light, Dark, Sepia, Obsidian Night, Midnight, Cosmos and Pandora','Light, Pastel, Mint, Sunset, Lavender and AMOLED')
...
s=s.replace('val themes=linkedMapOf(ThemeManager.LIGHT to "Light",ThemeManager.DARK to "Dark",ThemeManager.SEPIA to "Sepia",ThemeManager.AMOLED to "Obsidian Night",ThemeManager.MIDNIGHT to "Midnight Blue",ThemeManager.COSMOS to "Cosmos • Galaxy",ThemeManager.AVATAR to "Pandora • Avatar")','val themes=linkedMapOf(ThemeManager.LIGHT to "Light",ThemeManager.PASTEL to "Pastel",ThemeManager.MINT to "Mint",ThemeManager.SUNSET to "Sunset",ThemeManager.LAVENDER to "Lavender",ThemeManager.AMOLED to "AMOLED")')
p.write_text(s)
p=B/'app/src/main/java/com/localqbank/library/QuizActivity.kt';s=p.read_text();s=s.replace('''listOf(
