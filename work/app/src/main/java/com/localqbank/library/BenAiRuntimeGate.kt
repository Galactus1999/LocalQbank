...
object BenAiResourceGate {
    ...
    fun mayRun(
        ...
        // Power-save allows small models to keep running for a foreground study interaction,
        // but still blocks large models from spinning up while the device is conserving power.
        if (powerSave && estimatedModelMb > MIN_FREE_HEADROOM_MB) return false
        return true
    }
}
